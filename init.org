...
(use-package eca
  ...
  (defun my/eca-brainstorm-active-buffers ()
    ...
    (let* ((all-buffers (mapcar #'window-buffer (window-list)))
      ...
      (eca-chat-new :agent "py-brainstorm-3-flash")
    ...
    (if (not (buffer-file-name))
      ...
      (let ((file-name (file-name-nondirectory (buffer-file-name))))
        ...
        (unless (and (fboundp 'eca-process-live-p) (eca-process-live-p))
          (eca))
        ;; Initialize session
        (eca-chat-new :agent "py-fixer-3-flash")
  ...
  :bind* (
          ...
          ("H-a t" . (lambda () (interactive) (unless (and (fboundp 'eca-process-live-p) (eca-process-live-p)) (eca)) (eca-chat-new)))

...
;; (setq jupyter-repl-echo-eval-p t) # this might be needed
;; associate it to a repl buffer
;; create and name repls
;; jupytext with notebook and python files?
;; can i connect to a jupyter on a server?
#+end_src
*** Scimax 
#+begin_src emacs-lisp :lexical t  
(use-feature ox-clip

...
(use-package code-cells
  ...
  :bind (
         ...
         ("C-c c a" . (lambda() (interactive) (seth-code-cells/add-time-stamp-after-execute 1)))
         ("C-c c b" . (lambda() (interactive) (seth-code-cells/add-cell 1))) ;; add above
         ("C-<return>" . (lambda() (interactive) (seth-code-cells/add-cell ))) ;; add below

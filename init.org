...
(use-package mu4e
  ...
  (add-to-list 'mu4e-view-actions
               '("Import S/MIME cert" . (lambda (msg)
                                          (shell-command (format "gpgsm --import %s" 
  ...
  (require 'epg)
  (setq mml-smime-use 'epg                 ; Use EasyPG for S/MIME
        mml-default-sign-method "smime"    ; Set default signature to S/MIME
        ;; Use the fingerprint you found with 'gpgsm --list-keys'
        smime-keys '(("seth.figueroa@focusae.com" "900DE5BC28610178AF63A9B299CA27445972C35D" nil))
        )

  
  ;; Automatically sign all outgoing mu4e messages
  ;; (add-hook 'mu4e-compose-mode-hook 'mml-secure-message-sign-smime)

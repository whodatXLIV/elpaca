...
(use-package counsel-tramp
  ...
  :defer t
  :init
  (setq counsel-tramp-custom-connections '(/ssh:sfigueroa@dev:~/ /ssh:sfigueroa@dev:~/elcano/ ))
  (setq counsel-tramp-default-method "ssh")
...
(use-package tree-sitter
  ...
  (add-hook 'prod-mode-hook #'tree-sitter-hl-mode)
  )

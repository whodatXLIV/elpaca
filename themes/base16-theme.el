...
;;;; nxml-mode
     (nxml-name-face                               :foreground nil :inherit font-lock-constant-face)
     (nxml-attribute-local-name-face               :foreground nil :inherit font-lock-variable-name-face)
     (nxml-ref-face                                :foreground nil :inherit font-lock-preprocessor-face)
     (nxml-delimiter-face                          :foreground nil :inherit font-lock-keyword-face)
     (nxml-delimited-data-face                     :foreground nil :inherit font-lock-string-face)
